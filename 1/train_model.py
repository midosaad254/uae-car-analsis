...
def load_and_preprocess_data(file_path):
    ...
    df['Cylinders'] = pd.to_numeric(df['Cylinders'], errors='coerce')  # تحويل النصوص لأرقام، وأي خطأ يتحول لـ NaN
    df['Cylinders'] = df['Cylinders'].fillna(df['Cylinders'].median())  # ملء القيم المفقودة بالمتوسط
...
if __name__ == "__main__":
    ...
    # التحقق من البيانات (بالإنجليزي عشان يشتغل بدون مشاكل)
